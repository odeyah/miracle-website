		...
		() => [
			...
			},
			{
				...
				story: (
					<>
						...
						<p style={{ marginBottom: '0.5rem' }}>
							התחלתי לצאת שוב לעולם הדייטים. ברוך השם, מהר מאוד הוא שלח לי את החצי השני שלי — את האישה הטובה והמושלמת ביותר
							בשבילי.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
			...
			},
			{
				...
				story: (
					<>
						<p style={{ marginBottom: '0.5rem' }}>
							כשהייתי גרוש, תוך כדי אימון לזוגיות, עשיתי טיפולי פוריות כי אין לי זרע בצורה טבעית.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							בזמן שהייתי נשוי, טיפולים אלה לא התקדמו. הרופאים אמרו שהסיכוי להצליח נמוך מאוד – פחות מ־2%, וזה היה מאוד מייאש.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							לאחר מכן עברתי לטיפול אצל פרופסור טליה גבע במינונים גבוהים יותר, והתוצאות השתפרו, אך עדיין לא היה זרע.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							בעצת המאמן שלי, הלכתי לקבל דעה שניה אצל פרופסור מומחה, שהציע להוסיף זריקה של הורמון נוסף. פרופסור טליה גבע
							קיבלה בשמחה את ההצעה, והתחלתי לקחת את הזריקה על בסיס יומי.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							כעבור חצי שנה של הטיפול המשולב, הגוף שלי התחיל לייצר זרע, כך שגם ניתוח כבר לא היה נחוץ. הודו לה' כי טוב.
						</p>
					</>
				),
				category: 'רפואה',
			...
			},
			{
				...
				story: (
					<>
						...
						<p style={{ marginBottom: '0.5rem' }}>
							כילד קטן הייתי הולך לבית חולים לעיתים קרובות, עד שאמא שלי התנדבה להביא לי את הזריקות בעצמה, וכך ירד התדירות לכל
							שלושה חודשים.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
			...
			},
			{
				...
				story: (
					<>
						<p style={{ marginBottom: '0.5rem' }}>נולדתי עם תסמונת נדירה של חוסר בהורמונים, בלי שידעו את זה מראש.</p>
						<p style={{ marginBottom: '0.5rem' }}>
						...
						<p style={{ marginBottom: '0.5rem' }}>
							...
							לזהות תסמונות נדירות בתינוקייה.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
			...
			},
			{
				...
				story: (
					<>
						<p style={{ marginBottom: '0.5rem' }}>הנס של החיים שלי התחיל בכלל 3 וחצי שנים לפני שנולדתי.</p>
						<p style={{ marginBottom: '0.5rem' }}>באותה תקופה, אמא שלי הייתה בהריון השני שלה – עם אחותי הגדולה.</p>
						<p style={{ marginBottom: '0.5rem' }}>
							את אחי הבכור היא ילדה בבית החולים הדסה עין כרם, כשבאותם ימים ההורים גרו בשכונת גבעת מרדכי.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							כדי להיות מוכנה לכל מקרה, אמא שלי הלכה להירשם ללידה גם בהדסה עין כרם וגם בבית החולים שערי צדק.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							כשהגיעה לשערי צדק, הפקידה שאלה אותה: "אני רואה שילדת את הקודם בעין כרם – למה את באה עכשיו אלינו?"
						</p>
						<p style={{ marginBottom: '0.5rem' }}>השאלה הזו פגעה בה מאוד. אמא שלי נעלבה, הסתובבה ויצאה בלי להירשם.</p>
						<p style={{ marginBottom: '0.5rem' }}>
							כשלוש שנים אחר כך, כשהייתה בהריון איתי, היא כבר לא חשבה בכלל על שערי צדק והלכה ישר להירשם בהדסה עין כרם.
						</p>
						<p style={{ marginBottom: '0.5rem' }}>
							נולדתי בחול המועד פסח – ואם אותה פקידה הייתה מקבלת את אמא שלי בחיוך, כנראה שהייתי נולד בכלל בשערי צדק.
						</p>
